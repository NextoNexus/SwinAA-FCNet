...
parser.add_argument("--test_dir", type=str,
                    dest="test_dir",
                    default='E:/docs/under_graduate/datasets/LPBA40_pkl/Test_best/')
parser.add_argument("--model_dir", type=str,
                    dest="model_dir",
                    default='./Experiments_LPBA/trained_model_SwinSCA/')
parser.add_argument("--model_file", type=str,
                    dest="model_file",
                    default='Model_SwinSCA_0.71391_iter151360.pth')
...
def main():
    ...
    #model=TeP(enc_nf_img=[16,32,64,128], enc_nf_hf=[16,32,64,128], inshape=imgshape)
    ...
    test_composed = transforms.Compose(
        [
            trans.Seg_norm(dataset_name=dataset_name),
            trans.NumpyType((np.float32, np.int16))
        ]
    )

    test_set = datasets.LPBA_InferDataset(root_dir=test_dir, case_dirs=os.listdir(test_dir), transforms=test_composed)
    ...
    with torch.no_grad():
        ...
        print('mean results:......................................>')
        print('mean time:', infer_time.avg, '±', infer_time.std)
        print('mean jac:', jac.avg, '±', jac.std)
        print('mean DSC:', dice.avg, '±', dice.std)
        print('mean hd95:', hd95.avg, '±', hd95.std)
        print('mean assd:', assd.avg, '±', assd.std)
